    ...
    <div className="max-w-7xl mx-auto px-6 py-6">
      ...
      <div className="space-y-12">
        ...
        <section id="quick-wins">
          <div className="flex items-center gap-2 mb-4">
            <div className="bg-success-100 text-success-600 w-8 h-8 rounded-full flex items-center justify-center font-semibold text-lg">2</div>
        ...
        <section id="medium-term-plays">
          <div className="flex items-center gap-2 mb-4">
            <div className="bg-warning-100 text-warning-600 w-8 h-8 rounded-full flex items-center justify-center font-semibold text-lg">3</div>
        ...
        <section id="strategic-bets">
          <div className="flex items-center gap-2 mb-4">
            <div className="bg-secondary-100 text-secondary-600 w-8 h-8 rounded-full flex items-center justify-center font-semibold text-lg">4</div>
